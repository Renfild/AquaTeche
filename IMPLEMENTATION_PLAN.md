...
| **2026-09-07** | `v2.8.51` | ZCode AI | **Визуал-пак по референсам (aqualumen 0.3.39 + aquatech_ui 1.0.60, пак 2.9.307):** единая палитра рангов во всех поверхностях (LumenTheme = палитра магазина; сайт-карточки с семантическим --rc), пиксельная монета 32×32 с гравировкой-каплей вместо логотипа-ромба (топбар, БП, HUD), каскад-анимация карточек 30мс (только на смене вкладки), градиент логотипа хаба под цвет ранга игрока, зелёная галочка у цены активных привилегий, VIP-кит с цветной рамкой, FTB-ошибки квестов свёрнуты в одну серую строку. TAB/HUD/чат — единый пилл префикса (цвет ранга, обычный регистр, канонический титул). Деплой 2.9.307 с md5-верификацией CDN, сервер на 0.3.39/1.0.60, smoke зелёный. Превью: scratch/referenc_mcskill/v6_*.png. | `tools/build_hub_html.py`, `LumenTheme.java`, `AquaChatManager.java`, `OceanTabOverlay.java`, `OceanHudOverlay.java`, `docs/assets/js/site.js`, `docs/assets/css/site.css`, `docs/assets/images/coin_pixel.png` |
