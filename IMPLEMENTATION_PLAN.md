...
| **2026-08-06** | `v1.9.0` | Antigravity AI | Удалены предметы Avaritia (инфернальное/кристальное ядро, шаблон, сет брони) из дропа рыбалки, усложнен крафт всех удочек (пластины IU, схемы, резина, минералы), добавлены эндгейм-крафты Умножителей улова (x32 и x64), добавлена трата прочности удочек при вылове. | `FishingLootHandler.java`, `20_aquatech_rod_crafts.js`, `30_aquatech_crafting.js`, `aquatech_ui-1.0.0.jar` |
