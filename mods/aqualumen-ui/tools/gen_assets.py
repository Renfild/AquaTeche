...
ICONS = {
    ...
    "gavel": '<path d="m13.2 6.2 4.6 4.6"/><path d="m10.9 8.5 4.6 4.6"/><rect x="11.7" y="3.4" width="7.4" height="4.2" rx="1" transform="rotate(45 15.4 5.5)"/><path d="M13.9 10.1 5.6 18.4a1.6 1.6 0 0 0 2.3 2.3l8.3-8.3"/>',
}
