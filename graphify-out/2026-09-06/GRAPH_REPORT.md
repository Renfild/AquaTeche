# Graph Report - AquaTech  (2026-09-06)

## Corpus Check
- 755 files · ~806,171 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5499 nodes · 11849 edges · 365 communities (226 shown, 59 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 327 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9bc5eeee`
...
## Communities (365 total, 59 thin omitted)
...
Cohesion: 0.10
Nodes (13): Boost, ItemStack, JsonObject, Mod.EventBusSubscriber, PlayerLoggedInEvent, ServerTickEvent, OceanEventsService, Quest (+5 more)
...
Cohesion: 0.12
Nodes (5): com.mojang.brigadier.CommandDispatcher, LumenCommands, Data, FishDef, FishShopConfig
...
Cohesion: 0.09
Nodes (12): ClientboundBlockEntityDataPacket, ClientGamePacketListener, AutoFisherBlockEntity, Connection, ContainerData, Override, ContainerData, ContainerData (+4 more)
...
Cohesion: 0.06
Nodes (25): EntityMultiPlaceEvent, AquaTechUI, CapabilityEvents, Clone, Mod.EventBusSubscriber, PlayerLoggedInEvent, BreakEvent, Mod.EventBusSubscriber (+17 more)

### Community 29 - "AquaTechUI.java"
Cohesion: 0.14
Nodes (14): ModRegistries, AbyssalMagnetItem, Mod.EventBusSubscriber, ModCreativeTabs, ModItems, ModSounds, net.minecraft.sounds.SoundEvent, net.minecraft.world.item.CreativeModeTab (+6 more)
...
### Community 34 - "IslandGuardHandler"
Cohesion: 0.15
...
### Community 42 - "WarpConfig"
Cohesion: 0.15
Nodes (12): com.mojang.brigadier.builder.LiteralArgumentBuilder, CaseConfig, CaseDef, Daily, Data, RandomSource, LootDef, PendingCaseReward (+4 more)
...
Cohesion: 0.03
Nodes (33): ClientHello, HubAction, PlayerProfile, ServerStats, C2SOpenSkillTreePacket, Context, C2SRhythmHookResultPacket, Context (+25 more)
...
### Community 59 - "net.minecraft.server.level.ServerLevel"
Cohesion: 0.10
Nodes (11): IslandLimiterHandler, BreakEvent, EntityPlaceEvent, Mod.EventBusSubscriber, IslandLimiterRules, IslandLimiterTracker, CompoundTag, Override (+3 more)
...
### Community 79 - "AutoFisherBlockEntity.java"
Cohesion: 0.10
...
### Community 82 - "n7"
Cohesion: 0.07
Nodes (12): animate(), n7, l(), se, sG(), C(), sj, sq (+4 more)
...
### Community 99 - "AquaSkillCapability.java"
Cohesion: 0.16
...
Cohesion: 0.03
Nodes (71): A(), a0(), a2(), a3(), a4(), aa(), ab(), adjustCameraDistance() (+63 more)
...
Cohesion: 0.07
Nodes (55): g(), m(), av(), aw(), b(), h, I, n4() (+47 more)

### Community 115 - "ChestFallbackUI.java"
Cohesion: 0.16
...
Cohesion: 0.12
Nodes (13): com.google.gson.Gson, com.google.gson.JsonArray, AquaLumenUI, Mod.EventBusSubscriber, ServerEvents, PendingDeliveryService, LumenConfig, LumenNetwork (+5 more)

### Community 129 - "RateModItem.java"
Cohesion: 0.15
...
### Community 136 - "ej"
Cohesion: 0.05
Nodes (11): m(), o(), ej, eN(), eO(), eV(), sr(), i() (+3 more)
...
### Community 164 - "AquaTechFishingRodItem.java"
Cohesion: 0.07
Nodes (15): Override, Override, Override, Override, SonarGogglesItem, Override, UpgradeItem, UpgradeType (+7 more)

### Community 167 - "SkillDefinitions"
Cohesion: 0.22
Nodes (6): NodeType, KEYSTONE, NOTABLE, SMALL, SkillDef, SkillDefinitions

### Community 172 - "tg"
Cohesion: 0.06
Nodes (11): aC(), ai(), al, p(), n2(), O, so, t3 (+3 more)
...
Cohesion: 0.43
Nodes (7): bump_pack_version(), copy_jars_to_targets(), main(), md5_file(), Increment the patch version in publish_client_pack.py and…, run(), wait_for_apex()

### Community 212 - "Path"
Cohesion: 0.25
Nodes (12): Path, bump_jar(), main(), _cp(), _ensure_compiled(), _java(), _javac(), main() (+4 more)

### Community 213 - ".multiplyScalar"
Cohesion: 0.04
Nodes (12): f(), s(), e2, eo(), ex, S(), eA(), eT() (+4 more)
...
### Community 217 - "KitConfig"
Cohesion: 0.22
Nodes (5): ResourceLocation, Data, KitConfig, KitDef, KitItem

### Community 218 - "RhythmHookSession.java"
Cohesion: 0.19
...
### Community 228 - ".copy"
Cohesion: 0.04
Nodes (11): e5, n0, n1, om, sc, sn, eH(), T() (+3 more)
...
### Community 256 - "tU"
Cohesion: 0.06
Nodes (16): ag, aM(), as(), r(), ax(), ay(), dispose(), oa (+8 more)

### Community 259 - "ForgeInstaller"
Cohesion: 0.48
...
Cohesion: 0.21
Nodes (11): Dictionary, DiscordPresenceService, ClientId, Enabled, CancellationToken, CancellationTokenSource, Data, Stream (+3 more)
...
### Community 319 - ".QueryStatusAsync"
Cohesion: 0.33
...
### Community 349 - "AquaTechCommand.java"
Cohesion: 0.15
Nodes (4): NetworkHandler, Context, S2CSyncSkillsPacket, net.minecraftforge.fml.event.lifecycle.FMLCommonSetupEvent

### Community 352 - "PersonalRaftSpawner.java"
Cohesion: 0.14
...
## Knowledge Gaps
- **1005 isolated node(s):** `$schema`, `registry`, `blocks`, `components`, `assets` (+1000 more)
...
- **Why does `CustomFishingLootManager` connect `CustomFishingLootManager` to `AquaTechCommand.java`, `HubDataService.java`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `LaunchCommandBuilder` connect `.BuildAsync` to `LauncherConfig`, `Fact`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `FishShopConfig` connect `FishShopConfig` to `KitConfig`, `WarpConfig`, `HubDataService.java`?**
