# Graph Report - AquaTech  (2026-08-11)

## Corpus Check
- 426 files · ~171,413 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2205 nodes · 3771 edges · 203 communities (164 shown, 39 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 43 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a8b693f7`
...
## Communities (203 total, 39 thin omitted)
...
### Community 1 - "ZipFile"
Cohesion: 0.05
Nodes (61): main(), strip_mc(), title_for(), bump_jar(), main(), Path, _asm_classpath(), _ensure_patcher_compiled() (+53 more)
...
Cohesion: 0.07
Nodes (37): ThreadingHTTPServer, check_launcher_update_available(), fetch_bootstrap_manifest(), _fetch_json_hard(), fetch_remote_pack_manifest(), find_java(), _hex_to_rgb(), _http_download() (+29 more)
...
### Community 10 - "Path"
Cohesion: 0.10
Nodes (31): _app_dir(), _asset_object_path(), _bundle_dir(), ensure_assets(), ensure_forge_minecraft_srg(), ensure_launcher_profiles(), find_bundled_forge_installer(), find_bundled_forge_runtime_zip() (+23 more)

### Community 11 - "What You Must Do When Invoked"
Cohesion: 0.08
Nodes (24): For /graphify add and --watch, For /graphify query, For the commit hook and native CLAUDE.md integration, For --update and --cluster-only, /graphify, Honesty Rules, Interpreter guard for subcommands, Part A - Structural extraction for code files (+16 more)

### Community 12 - "🏗️ Разделение на Технические Задания (ТЗ)"
Cohesion: 0.08
Nodes (24): 🗺️ Master Implementation Plan: AquaTech Minecraft 1.20.1 (Forge + Mohist), 📜 Журнал Ревизий и История Изменений (Revision History), 🔄 Как обновлять клиентскую сборку (чеклист), 🎯 Общий обзор архитектуры проекта, Основная концепция сборки:, ⚙️ Поэтапная реализация ТЗ-1:, ⚙️ Поэтапная реализация ТЗ-2:, ⚙️ Поэтапная реализация ТЗ-3: (+16 more)
...
Cohesion: 0.16
Nodes (9): com.google.gson.Gson, java.lang.reflect.Type, CasesMod, PityManager, net.minecraftforge.event.RegisterCommandsEvent, net.minecraftforge.event.server.ServerStartingEvent, net.minecraftforge.fml.common.Mod, net.minecraftforge.fml.event.lifecycle.FMLCommonSetupEvent (+1 more)
...
### Community 26 - "ApiHandler"
Cohesion: 0.30
Nodes (4): BaseHTTPRequestHandler, ApiHandler, Path, ui_dir()
...
Cohesion: 0.11
Nodes (23): _artifact_path(), build_launch_cmd(), ensure_default_russian_options(), ensure_forge_language_providers(), ensure_libraries_and_natives(), ensure_vanilla_client_jar(), ensure_vanilla_version_json(), _forge_lang_provider_specs() (+15 more)

### Community 29 - "AquaTechLauncher.Core"
Cohesion: 0.12
Nodes (6): AquaTechLauncher.Core, FileNotFoundException, FileNotFoundError, ServerPing, SessionStore, string
...
Cohesion: 0.12
Nodes (14): EntityInteract, MinecraftServer, FishMarketNpcInteract, Mod.EventBusSubscriber, MenuOpenerItem, ServerPlayer, NetworkHandler, net.minecraft.world.entity.Entity (+6 more)
...
### Community 42 - "install_aquatech_rank_prefixes.py"
Cohesion: 0.36
...
### Community 47 - "App.axaml.cs"
Cohesion: 0.22
Nodes (5): Application, AquaTechLauncher.Views, App, MainWindow, Window

### Community 48 - ".calculatePrice"
Cohesion: 0.36
...
### Community 68 - "check_pack_update_available"
Cohesion: 0.22
Nodes (10): apply_manifest_sync(), build_manifest_from_pack(), check_pack_update_available(), md5_file(), _pack_looks_ready(), Heuristic: pack already installed — skip long CDN timeout cascades on Play., Apply pack manifest to game_dir. Returns (updated, failed, deleted).…, Scan local pack and build an in-memory manifest (md5 + size). (+2 more)
...
### Community 73 - "spawn_minecraft"
Cohesion: 0.67
Nodes (3): Popen, Start Minecraft in its own process group with console capture. stdout/stderr go…, spawn_minecraft()

### Community 74 - "AquaTechLauncher.ViewModels"
Cohesion: 0.20
Nodes (6): Control, AquaTechLauncher.ViewModels, IDataTemplate, ViewLocator, ViewModelBase, ObservableObject
...
Cohesion: 0.33
Nodes (5): AquaTech — agent guidance, AquaTech release reminders, caveman + agent skills, graphify (memory / codebase map), gstack
...
### Community 91 - "AquaTechLauncher"
Cohesion: 0.29
Nodes (4): AppBuilder, AquaTechLauncher, Program, STAThread
...
Cohesion: 0.16
Nodes (5): BaseException, _friendly_portal_error(), LauncherEngine, _portal_post(), Runs Play/Update without Tk; pushes logs to a ring buffer for the web UI.

### Community 193 - ".PingAsync"
Cohesion: 0.40
Nodes (3): Task, Ms, Online

### Community 194 - "net.minecraft.network.FriendlyByteBuf"
Cohesion: 0.19
Nodes (5): CaseResultS2CPacket, Context, Context, OpenFishMarketS2CPacket, net.minecraft.network.FriendlyByteBuf
...
## Knowledge Gaps
- **598 isolated node(s):** `aquatech/bootstrap`, `version`, `mc_version`, `forge_version`, `server_ip` (+593 more)
