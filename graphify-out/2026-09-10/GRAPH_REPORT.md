# Graph Report - AquaTech  (2026-09-10)

## Corpus Check
- 780 files · ~934,622 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6169 nodes · 12880 edges · 369 communities (225 shown, 61 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 328 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `09b2e1c6`
...
Cohesion: 0.22
Nodes (4): com.google.gson.JsonObject, MarketEntry, JsonObject, MarketService

### Community 2 - "net.minecraft.server.level.ServerPlayer"
Cohesion: 0.08
Nodes (9): PlayerLoggedInEvent, PlayerLoggedOutEvent, ServerTickEvent, HubActionHandler, ItemStack, HubEconomy, Product, StoreCatalog (+1 more)
...
### Community 17 - "net.minecraft.world.item.ItemStack"
Cohesion: 0.08
Nodes (14): Close, java.lang.reflect.Constructor, ItemStack, FishingRodCompat, Mod.EventBusSubscriber, PlayerTickEvent, RightClickItem, RateModPersistHandler (+6 more)
...
Cohesion: 0.06
Nodes (25): NodeType, KEYSTONE, NOTABLE, SMALL, SkillCategory, AIR, ALL_BONUS, CATCH_MULT (+17 more)
...
### Community 21 - "te"
Cohesion: 0.05
Nodes (9): ab(), h(), background(), e9(), a(), sa(), ss, st (+1 more)
...
### Community 25 - "AutoFisherBlockEntity"
Cohesion: 0.06
Nodes (16): ClientboundBlockEntityDataPacket, ClientGamePacketListener, AutoFisherBlockEntity, Connection, ContainerData, Override, ItemStack, Override (+8 more)
...
Cohesion: 0.04
Nodes (48): Detonate, java.lang.reflect.Field, java.lang.reflect.Method, AquaTechUI, CapabilityEvents, Clone, Mod.EventBusSubscriber, PlayerLoggedInEvent (+40 more)
...
### Community 51 - "NetworkHandler.java"
Cohesion: 0.09
Nodes (9): PlayerProfile, ServerStats, ChatBubblePacket, Context, Context, SyncAllProfilesPacket, Context, SyncServerStatsPacket (+1 more)
...
Cohesion: 0.18
Nodes (11): Body, CookieContainer, CookieSession, HttpClient, HttpDownload, CancellationToken, Task, SocketsHttpHandler (+3 more)
...
Cohesion: 0.14
Nodes (15): Error, NewsItem, DateLabel, PortalApi, PortalStats, Online, PlayersMax, PlayersOnline (+7 more)
...
Cohesion: 0.06
Nodes (23): AquaFishCaughtEvent, AquaTechFishingRodItem, RodType, ABYSSAL, DIAMOND, EMERALD, ENDER, GOLD (+15 more)
...
### Community 99 - "ChestFallbackUI.java"
Cohesion: 0.16
...
Cohesion: 0.06
Nodes (21): AutoFisherMenu, FishSmokerMenu, OceanAltarMenu, OceanFilterMenu, SeabedDredgerMenu, TackleBoxMenu, C2SOpenSkillTreePacket, Context (+13 more)
...
Cohesion: 0.02
Nodes (63): a0(), a2(), a3(), a4(), adjustCameraDistance(), aE(), aH(), aj() (+55 more)
...
### Community 111 - "e5"
Cohesion: 0.06
Nodes (8): e5, eR, n0, n1, B(), nb, nv(), ti
...
Cohesion: 0.05
Nodes (70): aa(), an(), aP(), n(), ar(), d(), g(), m() (+62 more)

### Community 115 - ".dot"
Cohesion: 0.07
Nodes (18): A(), a(), f(), e2, eo(), ex, ng(), n() (+10 more)
...
Cohesion: 0.08
Nodes (18): com.google.gson.Gson, java.lang.reflect.InvocationHandler, java.net.HttpURLConnection, java.util.regex.Pattern, AquaLumenUI, Mod.EventBusSubscriber, ServerEvents, SuppressWarnings (+10 more)

### Community 122 - "AutoFisherBlockEntity.java"
Cohesion: 0.05
Nodes (42): AquaSkillProvider, Override, AbyssalMagnetItem, Mod.EventBusSubscriber, Override, Override, RateModItem, RateTier (+34 more)

### Community 129 - "net.minecraft.server.level.ServerLevel"
Cohesion: 0.12
Nodes (14): AbyssalPearlItem, BlockPos, Override, Vec3, InfernalPearlHandler, BlockPos, Mod.EventBusSubscriber, RightClickBlock (+6 more)
...
### Community 136 - "ej"
Cohesion: 0.05
Nodes (8): ej, eB(), eH(), eO(), eV(), i(), tV, tW
...
### Community 172 - "tg"
Cohesion: 0.08
Nodes (9): aC(), ai(), al, S(), sc, t3, tg, tl (+1 more)
...
Cohesion: 0.12
Nodes (30): main(), wg_flag_cmd(), apex_command(), apex_create_backup(), apex_delete_backup(), _apex_headers(), apex_json(), apex_list_backups() (+22 more)
...
Cohesion: 0.08
Nodes (13): SkillEffects, Snapshot, Override, Override, Override, Override, Override, Override (+5 more)
...
### Community 198 - "Json"
Cohesion: 0.03
Nodes (6): Json, Harden aquatech StarCatcher fish: real minigame difficulty, no skip., Neutralize aquatech SC fish preview (loot still from AquaTech rod pools)., get_texture_b64(), main(), Boost density of vanilla underwater vegetation/decoration features (kelp,…
...
### Community 202 - "net.minecraftforge.registries.RegistryObject"
Cohesion: 0.18
Nodes (10): ModRegistries, ModCreativeTabs, ModSounds, net.minecraft.sounds.SoundEvent, net.minecraft.world.item.CreativeModeTab, net.minecraftforge.eventbus.api.IEventBus, net.minecraftforge.registries.DeferredRegister, net.minecraftforge.registries.RegistryObject (+2 more)
...
### Community 212 - "Path"
Cohesion: 0.50
Nodes (8): Path, _cp(), _ensure_compiled(), _java(), _javac(), main(), patch_jar(), Remove IU free ore-scanner give from IUCore.loginPlayer. Usage: python…
...
### Community 214 - "AquaSkillCapability"
Cohesion: 0.05
Nodes (15): com.mojang.brigadier.CommandDispatcher, AquaSkillCapability, CompoundTag, DailyContract, DEPTH, FISH, KELP, MACHINE (+7 more)
...
Cohesion: 0.18
Nodes (4): FishingLootHandler, ItemStack, Mod.EventBusSubscriber, net.minecraft.util.RandomSource
...
Cohesion: 0.19
Nodes (6): BlockPos, Clone, Mod.EventBusSubscriber, PlayerLoggedInEvent, PersonalRaftSpawner, PlayerRespawnEvent
...
Cohesion: 0.23
Nodes (7): mezz.jei.api.IModPlugin, mezz.jei.api.JeiPlugin, mezz.jei.api.runtime.IJeiRuntime, AquaTechJeiPlugin, ItemStack, Override, net.minecraft.resources.ResourceLocation
...
### Community 237 - "eM"
Cohesion: 0.03
Nodes (14): animate(), eM, m(), H(), n7, n8, se, sG() (+6 more)
...
### Community 256 - "tU"
Cohesion: 0.09
Nodes (15): ag, aM(), ao(), r(), as(), r(), ax(), ay() (+7 more)
...
### Community 286 - "FishSmokerBlockEntity"
Cohesion: 0.16
Nodes (4): FishSmokerBlockEntity, ItemStack, Override, FishPriceTable
...
### Community 292 - "RaftRegistry"
Cohesion: 0.25
Nodes (4): Entry, CompoundTag, Override, RaftRegistry
...
- **1513 isolated node(s):** `$schema`, `registry`, `blocks`, `components`, `assets` (+1508 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 2553 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **61 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `x` connect `x` to `.copy`, `skinview3d.bundle.js`, `sh`, `.constructor`, `.dot`, `.makeEmpty`, `W`, `tn`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `HttpDownload` connect `HttpDownload` to `AquaTechLauncher.Core`, `.LoginAsync`, `.ApplyAsync`, `MainViewModel`, `Fact`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `AquaTechLauncher.Core` connect `AquaTechLauncher.Core` to `PortalCallbackListener`, `.LoginAsync`, `.CheckAndApplyAsync`, `.ApplyAsync`, `SystemDiagnostics`, `.QueryStatusAsync`, `ServerListHelper`, `LogLine`, `Fact`, `.BuildAsync`, `.Load`, `.EnsureJava17Async`?**
