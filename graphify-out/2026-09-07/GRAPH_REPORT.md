...
## Corpus Check
- 758 files · ~825,307 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5540 nodes · 11985 edges · 364 communities (224 shown, 61 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 327 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5321034b`
...
## Communities (364 total, 61 thin omitted)
...
Cohesion: 0.12
Nodes (15): java.lang.reflect.Method, AquaTechUI, PlayerLoggedOutEvent, PlayerTickEvent, Context, S2CSyncSkillsPacket, net.minecraft.server.level.ServerLevel, net.minecraft.world.entity.Entity (+7 more)
...
### Community 35 - "DredgerEnergyStorage"
Cohesion: 0.20
Nodes (3): EnergyStorage, DredgerEnergyStorage, ContainerData

### Community 36 - "KitConfig"
Cohesion: 0.09
Nodes (11): com.mojang.brigadier.builder.LiteralArgumentBuilder, com.mojang.brigadier.CommandDispatcher, LumenCommands, Data, KitConfig, KitDef, KitItem, Data (+3 more)
...
Cohesion: 0.06
Nodes (20): AutoFisherBlock, BlockHitResult, Builder, Override, ContainerData, ContainerData, ContainerData, WorkingMachineTracker (+12 more)
...
### Community 70 - "n7"
Cohesion: 0.13
Nodes (6): animate(), n7, sj, sq, sX, sY
...
### Community 79 - "FishingSpeedHandler"
Cohesion: 0.32
...
Cohesion: 0.14
Nodes (13): 0.1.0-alpha, 0.2.0-alpha — движение и иконки, 0.2.1-alpha — векторные иконки, 0.2.2-alpha — иконки на SVG, 0.3.0-alpha — покупка с подтверждением, ревеал кейса, 23 иконки, 0.3.1-alpha — MCEF hub, 0.3.2-alpha — исправление загрузки MCEF, 0.3.35-alpha — магазин Apple HIG + ключи кейсов БП (+5 more)
...
Cohesion: 0.09
Nodes (9): AutoFisherMenu, OceanAltarMenu, OceanFilterMenu, SeabedDredgerMenu, TackleBoxMenu, ModMenuTypes, net.minecraft.world.entity.player.Inventory, net.minecraft.world.inventory.AbstractContainerMenu (+1 more)
...
Cohesion: 0.02
Nodes (78): A(), a0(), a2(), a3(), a4(), aa(), ab(), adjustCameraDistance() (+70 more)
...
### Community 111 - "e5"
Cohesion: 0.05
Nodes (11): e5, eR, n0, n1, n2(), B(), H(), nb (+3 more)
...
### Community 114 - ".copy"
Cohesion: 0.04
Nodes (56): f(), g(), m(), b(), ex, I, n4(), q() (+48 more)
...
Cohesion: 0.14
Nodes (13): com.google.gson.Gson, com.google.gson.JsonArray, AquaLumenUI, Mod.EventBusSubscriber, ServerEvents, LumenConfig, LumenNetwork, LumenPackets (+5 more)

### Community 122 - "net.minecraft.world.item.Item"
Cohesion: 0.04
Nodes (42): java.lang.reflect.Constructor, ModRegistries, AbyssalPortalBlock, BlockState, Override, AbyssalMagnetItem, Mod.EventBusSubscriber, Override (+34 more)

### Community 129 - "DeepBuildGuard"
Cohesion: 0.32
...
Cohesion: 0.06
Nodes (47): ClientboundBlockEntityDataPacket, ClientGamePacketListener, AutoFisherBlockEntity, Connection, Override, Override, OceanAltarBlockEntity, Override (+39 more)
...
### Community 172 - "tg"
Cohesion: 0.07
Nodes (11): aC(), ai(), al, d(), S(), sc, t3, tg (+3 more)
...
### Community 202 - ".constructor"
Cohesion: 0.04
Nodes (12): ar(), p(), u(), x(), f(), height(), O, ol (+4 more)
...
Cohesion: 0.06
Nodes (20): Close, ItemStack, ItemStack, ItemStack, FishingLootHandler, ItemStack, Mod.EventBusSubscriber, FishingRodCompat (+12 more)
...
Cohesion: 0.15
Nodes (8): java.lang.reflect.Field, mezz.jei.api.IModPlugin, mezz.jei.api.JeiPlugin, mezz.jei.api.runtime.IJeiRuntime, AquaTechJeiPlugin, Override, RodDurabilityApplier, net.minecraft.resources.ResourceLocation
...
### Community 237 - "eM"
Cohesion: 0.03
Nodes (8): eM, eo(), m(), nj(), nK(), nY(), eP(), eR()
...
### Community 256 - ".clone"
Cohesion: 0.05
Nodes (21): ag, aM(), as(), r(), av(), ax(), ay(), dispose() (+13 more)
...
### Community 286 - "RhythmHookSession.java"
Cohesion: 0.19
...
### Community 305 - "CapabilityEvents"
Cohesion: 0.25
...
## Knowledge Gaps
- **1007 isolated node(s):** `$schema`, `registry`, `blocks`, `components`, `assets` (+1002 more)
...
- **Why does `CustomFishingLootManager` connect `CustomFishingLootManager` to `net.minecraft.world.item.ItemStack`, `net.minecraftforge.eventbus.api.SubscribeEvent`, `ServerEvents.java`?**
...
- **Should `.buy` be split into smaller, more focused modules?**
