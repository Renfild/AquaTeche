# Graph Report - AquaTech  (2026-08-13)

## Corpus Check
- 607 files · ~301,140 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3370 nodes · 6924 edges · 265 communities (216 shown, 49 thin omitted)
...
- ForgeInstaller
- ui/network/NetworkHandler.java
...
Cohesion: 0.14
Nodes (8): com.google.gson.Gson, java.lang.reflect.Type, CasesMod, PityManager, net.minecraftforge.event.server.ServerStartingEvent, net.minecraftforge.fml.common.Mod, net.minecraftforge.fml.event.lifecycle.FMLCommonSetupEvent, org.apache.logging.log4j.Logger
...
Cohesion: 0.07
Nodes (18): CapabilityEvents, Clone, Mod.EventBusSubscriber, PlayerLoggedInEvent, BreakEvent, Mod.EventBusSubscriber, PlayerTickEvent, SkillPassiveHandler (+10 more)

### Community 26 - "FishSellService.java"
Cohesion: 0.24
Nodes (3): FishSellService, BalanceSyncS2CPacket, Context
...
Cohesion: 0.07
Nodes (28): ClientboundBlockEntityDataPacket, ClientGamePacketListener, Connection, AutoFisherBlockEntity, Override, Override, OceanAltarBlockEntity, AquaSkillProvider (+20 more)
...
### Community 31 - "AquaTechUI.java"
Cohesion: 0.07
Nodes (29): java.lang.reflect.Field, java.lang.reflect.Method, AquaTechUI, AbyssalMagnetItem, Mod.EventBusSubscriber, RateModItem, RateTier, X16 (+21 more)
...
### Community 36 - "ui/network/NetworkHandler.java"
Cohesion: 0.17
...
Cohesion: 0.07
Nodes (17): ContainerData, ContainerData, ContainerData, ContainerData, WorkingMachineTracker, Override, Override, Override (+9 more)
...
### Community 56 - "QuestEventHandler.java"
Cohesion: 0.31
...
### Community 70 - "SyncServerStatsPacket"
Cohesion: 0.16
...
### Community 73 - "PlayerAccountManager"
Cohesion: 0.24
...
### Community 194 - "StormEvent"
Cohesion: 0.11
Nodes (13): Deprecated, Mod.EventBusSubscriber, Override, Mode, AUTO, FORCE_OFF, FORCE_ON, StormEvent (+5 more)
...
Cohesion: 0.10
Nodes (9): C2SOpenSkillTreePacket, Context, C2SUnlockSkillPacket, C2SAuthPacket, Context, Context, S2CSessionSyncPacket, OpenCaseC2SPacket (+1 more)

### Community 211 - "FishMarketNpcInteract"
Cohesion: 0.33
Nodes (4): EntityInteract, FishMarketNpcInteract, Mod.EventBusSubscriber, net.minecraft.world.entity.Entity

### Community 212 - ".calculatePrice"
Cohesion: 0.18
Nodes (4): FishPriceCalculator, PriceResult, C2SSellFishPacket, Context
...
Cohesion: 0.15
Nodes (8): IslandGuardHandler, BlockPos, BreakEvent, EntityPlaceEvent, LivingHurtEvent, Mod.EventBusSubscriber, net.minecraftforge.event.CommandEvent, RightClickBlock
...
### Community 221 - "CaseListSyncS2CPacket"
Cohesion: 0.33
Nodes (5): CaseListSyncS2CPacket, CaseSnapshot, ItemSnapshot, Context, ServerPlayer

### Community 222 - "PersonalRaftSpawner"
Cohesion: 0.16
Nodes (7): ClassLoader, BlockPos, Mod.EventBusSubscriber, PlayerLoggedInEvent, RegisterCommandsEvent, PersonalRaftSpawner, net.minecraft.server.level.ServerLevel
...
Cohesion: 0.13
Nodes (8): HorizonEvents, BreakEvent, Mod.EventBusSubscriber, PlayerLoggedInEvent, PlayerTickEvent, NetworkHandler, PermissionsHelper, net.minecraft.server.level.ServerPlayer
...
Cohesion: 0.13
Nodes (6): ItemStack, Override, SeabedDredgerBlockEntity, CustomEnergyStorage, Override, net.minecraftforge.energy.EnergyStorage
...
### Community 234 - "RaftRegistry"
Cohesion: 0.19
Nodes (6): Detonate, Entry, CompoundTag, Override, RaftRegistry, PlayerRespawnEvent
...
### Community 241 - "UpgradeItem.java"
Cohesion: 0.19
Nodes (6): Override, UpgradeItem, UpgradeType, EFFICIENCY, SPEED, SPEED_X4
...
## Knowledge Gaps
- **689 isolated node(s):** `aquatech/bootstrap`, `version`, `mc_version`, `forge_version`, `server_ip` (+684 more)
...
- **Why does `CustomFishingLootManager` connect `CustomFishingLootManager` to `CasesMod.java`, `AquaTechCommand`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `LaunchCommandBuilder` connect `.BuildAsync` to `AquaTechLauncher.Core`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `PlayOrchestrator` connect `AquaTechLauncher.Core` to `ForgeInstaller`, `MainViewModel`, `.BuildAsync`, `.ApplyAsync`, `.EnsureJava17Async`?**
