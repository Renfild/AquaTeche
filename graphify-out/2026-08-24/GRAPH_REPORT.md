# Graph Report - AquaTech  (2026-08-24)

## Corpus Check
- 651 files · ~559,708 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3382 nodes · 7016 edges · 282 communities (236 shown, 46 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 93 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8906a526`
...
8. `AutoFisherBlockEntity` - 39 edges
9. `Пар — steam` - 39 edges
10. `MainViewModel` - 38 edges
...
## Communities (282 total, 46 thin omitted)

### Community 0 - "index.js"
Cohesion: 0.08
Nodes (85): onRequestPatch(), mapRow(), onRequestGet(), onRequestPost(), parsePerks(), SHORT, onRequestGet(), onRequestDelete() (+77 more)

### Community 1 - "CustomEnergyStorage"
Cohesion: 0.16
...
Cohesion: 0.18
Nodes (4): HubActionHandler, ItemStack, HubEconomy, net.minecraft.server.level.ServerPlayer
...
### Community 5 - "IslandGuardHandler"
Cohesion: 0.15
...
Cohesion: 0.06
Nodes (24): NodeType, KEYSTONE, NOTABLE, SMALL, SkillCategory, AIR, ALL_BONUS, CATCH_MULT (+16 more)
...
### Community 21 - "AutoFisherBlockEntity.java"
Cohesion: 0.16
Nodes (15): AquaSkillProvider, InventoryNbt, Override, OutputOnlyWrapper, net.minecraft.core.Direction, net.minecraft.network.chat.Component, net.minecraft.world.MenuProvider, net.minecraftforge.common.capabilities.Capability (+7 more)
...
### Community 25 - "net.minecraft.nbt.CompoundTag"
Cohesion: 0.14
Nodes (8): ClientboundBlockEntityDataPacket, ClientGamePacketListener, Connection, Override, Override, CompoundTag, net.minecraft.nbt.CompoundTag, Packet
...
### Community 28 - "ChestFallbackUI.java"
Cohesion: 0.16
...
### Community 29 - "FishingLootHandler.java"
Cohesion: 0.13
...
Cohesion: 0.10
Nodes (30): AbyssalPortalBlock, AutoFisherBlock, BlockHitResult, Builder, Override, BlockHitResult, Builder, Override (+22 more)
...
### Community 50 - "OceanAltarBlockEntity"
Cohesion: 0.23
Nodes (3): ContainerData, Override, OceanAltarBlockEntity

### Community 51 - "SkillPassiveHandler"
Cohesion: 0.22
...
Cohesion: 0.09
Nodes (21): CaseEntry, CaseResult, FishEntry, HubSnapshot, KitEntry, LootInfo, Offer, Profile (+13 more)
...
### Community 69 - "HubDataService.java"
Cohesion: 0.12
Nodes (14): com.google.gson.Gson, com.google.gson.JsonArray, com.google.gson.JsonObject, AquaLumenUI, Mod.EventBusSubscriber, ServerEvents, LumenConfig, LumenNetwork (+6 more)
...
### Community 79 - "net.minecraft.world.item.Item"
Cohesion: 0.12
Nodes (16): ModRegistries, AbyssalMagnetItem, Mod.EventBusSubscriber, PlayerLoggedOutEvent, PlayerTickEvent, ModCreativeTabs, ModItems, ModSounds (+8 more)
...
Cohesion: 0.20
Nodes (5): ResourceLocation, Data, FishDef, FishShopConfig, net.minecraft.resources.ResourceLocation
...
Cohesion: 0.05
Nodes (18): ClientHello, HubAction, C2SOpenSkillTreePacket, Context, C2SRhythmHookResultPacket, Context, C2SUnlockSkillPacket, C2SAuthPacket (+10 more)
...
### Community 114 - "FishingRodCompat"
Cohesion: 0.17
...
Cohesion: 0.16
Nodes (3): NetworkHandler, Context, S2CSyncSkillsPacket

### Community 122 - "net.minecraftforge.eventbus.api.SubscribeEvent"
Cohesion: 0.12
Nodes (17): java.lang.reflect.Field, AquaTechUI, CapabilityEvents, Clone, Mod.EventBusSubscriber, PlayerLoggedInEvent, net.minecraft.server.level.ServerLevel, net.minecraft.world.entity.Entity (+9 more)
...
Cohesion: 0.16
Nodes (9): AutoFisherMenu, Override, OceanAltarMenu, ModBlocks, ModMenuTypes, net.minecraft.world.entity.player.Inventory, net.minecraft.world.inventory.AbstractContainerMenu, net.minecraft.world.inventory.ContainerData (+1 more)

### Community 167 - "WarpConfig"
Cohesion: 0.12
Nodes (7): com.mojang.brigadier.CommandDispatcher, LumenCommands, ServerTickEvent, Data, ServerPlayer, WarpConfig, WarpDef
...
Cohesion: 0.53
Nodes (5): find_iu_texture(), main(), ZipFile, IU item ids look like baseore/silver — find a matching texture in the jar., slug()
...
### Community 198 - "Json"
Cohesion: 0.04
Nodes (3): Json, Harden aquatech StarCatcher fish: real minigame difficulty, no skip., Boost density of vanilla underwater vegetation/decoration features (kelp,…
...
Cohesion: 0.08
Nodes (16): AppBuilder, Application, Control, AquaTechLauncher.Views, AquaTechLauncher, AquaTechLauncher.ViewModels, DllImport, IDataTemplate (+8 more)
...
### Community 213 - "net.minecraft.core.BlockPos"
Cohesion: 0.09
Nodes (13): BlockState, Override, AutoFisherBlockEntity, WorkingMachineTracker, Override, Override, Override, Override (+5 more)
...
### Community 228 - "FishingSpeedHandler"
Cohesion: 0.38
Nodes (3): FishingSpeedHandler, Mod.EventBusSubscriber, PlayerTickEvent

### Community 229 - "net.minecraftforge.items.ItemStackHandler"
Cohesion: 0.20
Nodes (8): UpgradeItem, UpgradeType, EFFICIENCY, OCEAN_BOUNTY, SPEED, SPEED_X4, MachineUpgrades, net.minecraftforge.items.ItemStackHandler
...
### Community 236 - "SeabedDredgerBlockEntity"
Cohesion: 0.23
...
Cohesion: 0.67
Nodes (3): FISH_CATALOG, getDailyTrends(), openFishermanShop()
...
### Community 256 - "ForgeInstaller"
Cohesion: 0.44
Nodes (4): ForgeInstaller, Action, CancellationToken, Task

### Community 259 - "OceanFilterBlockEntity"
Cohesion: 0.23
...
### Community 279 - "RateModPersistHandler"
Cohesion: 0.33
Nodes (3): Mod.EventBusSubscriber, PlayerTickEvent, RateModPersistHandler

## Knowledge Gaps
- **749 isolated node(s):** `aquatech/bootstrap`, `version`, `mc_version`, `forge_version`, `server_ip` (+744 more)
...
- **Why does `PlayOrchestrator` connect `.PlayAsync` to `ForgeInstaller`, `AquaTechLauncher.Core`, `MainViewModel`, `.BuildAsync`, `.ApplyAsync`?**
...
- **Should `index.js` be split into smaller, more focused modules?**
  _Cohesion score 0.07532956685499058 - nodes in this community are weakly interconnected._
