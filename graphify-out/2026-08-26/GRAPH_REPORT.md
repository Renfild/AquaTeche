...
## Corpus Check
- 801 files · ~735,497 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6505 nodes · 10329 edges · 416 communities (371 shown, 45 thin omitted)
...
## Communities (416 total, 45 thin omitted)
...
Cohesion: 0.11
Nodes (7): com.mojang.brigadier.CommandDispatcher, JsonArray, LumenCommands, ServerTickEvent, Data, FishDef, FishShopConfig
...
Cohesion: 0.10
Nodes (10): BinaryWriter, AquaTechLauncher.Core, AquaTechLauncher.Core.Tests, HttpResponseMessage, ServerListHelper, AutoJoinArgumentTests, ManifestNeedsDownloadTests, ServerListHelperTests (+2 more)

### Community 23 - ".BuildAsync"
Cohesion: 0.26
Nodes (8): Func, LaunchCommandBuilder, ProcessSpawner, Action, CancellationToken, JsonObject, List, Task
...
Cohesion: 0.09
Nodes (14): ClientboundBlockEntityDataPacket, ClientGamePacketListener, AutoFisherBlockEntity, Connection, ContainerData, Override, ContainerData, ContainerData (+6 more)
...
Cohesion: 0.04
Nodes (44): java.lang.reflect.Field, java.lang.reflect.Method, AquaTechUI, CapabilityEvents, Clone, Mod.EventBusSubscriber, PlayerLoggedInEvent, BreakEvent (+36 more)
...
Cohesion: 0.07
Nodes (20): bool, double, Error, IBrush, Kind, PortalApi, PortalStats, UserProfile (+12 more)
...
Cohesion: 0.12
Nodes (8): CachedRank, HubDataService, ClassLoader, TopEntry, LevelData, Rank, SeasonData, WebTopRecord
...
### Community 69 - "StarCatcherEnchantmentHandler.java"
Cohesion: 0.33
...
Cohesion: 0.05
Nodes (45): Override, SeabedDredgerBlockEntity, AquaSkillProvider, Override, AbyssalMagnetItem, Mod.EventBusSubscriber, Override, Override (+37 more)
...
Cohesion: 0.10
Nodes (14): com.google.gson.Gson, com.google.gson.JsonArray, AquaLumenUI, Mod.EventBusSubscriber, PlayerLoggedInEvent, ServerEvents, LumenConfig, LumenNetwork (+6 more)
...
Cohesion: 0.16
Nodes (5): Override, OceanFilterBlockEntity, CustomEnergyStorage, Override, net.minecraftforge.energy.EnergyStorage

### Community 164 - "WarpConfig"
Cohesion: 0.27
Nodes (5): com.mojang.brigadier.builder.LiteralArgumentBuilder, Data, ServerPlayer, WarpConfig, WarpDef
...
Cohesion: 0.09
Nodes (11): SkillEffects, Snapshot, Override, Override, Override, Override, Override, Mod.EventBusSubscriber (+3 more)
...
Cohesion: 0.09
Nodes (14): Application, Control, AquaTechLauncher.Views, AquaTechLauncher, AquaTechLauncher.ViewModels, IDataTemplate, App, Kind (+6 more)
...
### Community 209 - "OceanAltarBlockEntity"
Cohesion: 0.23
...
Cohesion: 0.04
Nodes (25): ClientHello, HubAction, CompoundTag, PlayerProfile, ServerStats, C2SOpenSkillTreePacket, Context, C2SRhythmHookResultPacket (+17 more)
...
### Community 218 - "Program"
Cohesion: 0.32
Nodes (4): AppBuilder, DllImport, Program, STAThread
...
Cohesion: 0.10
Nodes (13): Detonate, Entry, BlockPos, ClassLoader, Clone, CompoundTag, Mod.EventBusSubscriber, Override (+5 more)
...
Cohesion: 0.11
Nodes (37): ae2_quests(), alex_quests(), avaritia_quests(), botania_quests(), esc(), filler_for(), fix_primitive_dupes(), hid() (+29 more)
...
Cohesion: 0.57
Nodes (6): computeTrends(), getDailyTrends(), localDay(), multFor(), openFishermanShop(), trendMessage()
...
Cohesion: 0.13
Nodes (15): CaseEntry, CaseResult, FishEntry, HubSnapshot, KitEntry, LootInfo, Offer, Profile (+7 more)
...
## Knowledge Gaps
- **2883 isolated node(s):** `perf`, `progress`, `nav`, `blindsContainer`, `i18n` (+2878 more)
...
- **Why does `FishShopConfig` connect `FishShopConfig` to `KitConfig`, `HubDataService.java`?**
