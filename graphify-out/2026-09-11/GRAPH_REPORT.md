# Graph Report - AquaTech  (2026-09-11)

## Corpus Check
- 782 files · ~1,079,271 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6215 nodes · 12994 edges · 378 communities (237 shown, 58 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 330 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2b42badc`
...
## Communities (378 total, 58 thin omitted)
...
### Community 1 - ".push"
Cohesion: 0.15
Nodes (6): com.google.gson.JsonObject, java.net.HttpURLConnection, MarketEntry, ItemStack, JsonObject, MarketService

### Community 2 - "net.minecraft.server.level.ServerPlayer"
Cohesion: 0.11
Nodes (7): PlayerLoggedInEvent, ServerTickEvent, TopEntry, HubEconomy, Product, StoreCatalog, net.minecraft.server.level.ServerPlayer
...
Cohesion: 0.14
Nodes (8): Close, java.lang.reflect.Constructor, Mod.EventBusSubscriber, PlayerTickEvent, RightClickItem, RateModPersistHandler, ItemStack, StarCatcherAttachments
...
Cohesion: 0.18
Nodes (13): Func, LaunchCommandBuilder, ProcessSpawner, Action, CancellationToken, IReadOnlyList, JsonArray, JsonObject (+5 more)
...
### Community 25 - "net.minecraftforge.registries.RegistryObject"
Cohesion: 0.16
Nodes (9): ModRegistries, ModCreativeTabs, ModSounds, net.minecraft.sounds.SoundEvent, net.minecraft.world.item.CreativeModeTab, net.minecraftforge.eventbus.api.IEventBus, net.minecraftforge.registries.RegistryObject, Registry (+1 more)
...
Cohesion: 0.07
Nodes (21): java.lang.reflect.Field, java.lang.reflect.Method, AquaTechUI, BooleanValue, ConfigValue, IntValue, ModConfig, PlayerLoggedOutEvent (+13 more)

### Community 29 - "FishSmokerBlockEntity"
Cohesion: 0.12
Nodes (8): FishSmokerBlockEntity, ClientboundBlockEntityDataPacket, ClientGamePacketListener, Connection, ItemStack, Override, Packet, FishPriceTable
...
### Community 31 - "tg"
Cohesion: 0.03
Nodes (13): aC(), al, X(), v(), S(), sc, sh, t3 (+5 more)
...
Cohesion: 0.17
Nodes (6): com.mojang.brigadier.CommandDispatcher, com.mojang.brigadier.context.CommandContext, AquaTechCommand, Mod.EventBusSubscriber, net.minecraft.commands.CommandSourceStack, net.minecraftforge.event.RegisterCommandsEvent
...
### Community 36 - "HubActionHandler"
Cohesion: 0.12
Nodes (9): CaseResult, CaseConfig, CaseDef, Daily, Data, RandomSource, LootDef, HubActionHandler (+1 more)
...
### Community 47 - "net.minecraft.core.BlockPos"
Cohesion: 0.06
Nodes (44): AbyssalPortalBlock, BlockState, Override, AutoFisherBlock, BlockHitResult, Builder, Override, ContainerData (+36 more)
...
Cohesion: 0.07
Nodes (13): ClientHello, HubAction, C2SOpenSkillTreePacket, Context, C2SRhythmHookResultPacket, Context, C2SAuthPacket, Context (+5 more)
...
Cohesion: 0.08
Nodes (21): CaseEntry, EventQuest, FishEntry, HubSnapshot, KitEntry, LootInfo, Offer, Profile (+13 more)
...
Cohesion: 0.20
Nodes (4): ResourceLocation, Data, FishDef, FishShopConfig

### Community 80 - "RodType"
Cohesion: 0.06
Nodes (21): AquaFishCaughtEvent, RodType, ABYSSAL, DIAMOND, EMERALD, ENDER, GOLD, IRON (+13 more)
...
### Community 96 - "AutoFisherBlockEntity"
Cohesion: 0.10
Nodes (10): AutoFisherBlockEntity, ClientboundBlockEntityDataPacket, ClientGamePacketListener, Connection, ContainerData, Override, Packet, CustomEnergyStorage (+2 more)
...
### Community 99 - "AquaTechJeiPlugin"
Cohesion: 0.15
Nodes (8): mezz.jei.api.IModPlugin, mezz.jei.api.JeiPlugin, mezz.jei.api.runtime.IJeiRuntime, AquaTechJeiPlugin, ItemStack, Override, RodDurabilityApplier, net.minecraft.resources.ResourceLocation
...
Cohesion: 0.07
Nodes (19): AutoFisherMenu, BlockPos, Override, FishSmokerMenu, BlockPos, Override, OceanAltarMenu, OceanFilterMenu (+11 more)
...
Cohesion: 0.02
Nodes (72): A(), a0(), a2(), a3(), a4(), ab(), adjustCameraDistance(), aE() (+64 more)
...
Cohesion: 0.05
Nodes (67): aa(), ai(), m(), aP(), n(), ar(), d(), f() (+59 more)

### Community 115 - "W"
Cohesion: 0.02
Nodes (9): e2, eo(), ex, eA(), eT(), w(), tk(), to (+1 more)
...
Cohesion: 0.11
Nodes (13): com.google.gson.Gson, java.sql.Connection, AquaLumenUI, Mod.EventBusSubscriber, ServerEvents, PendingDeliveryService, LumenConfig, LumenNetwork (+5 more)

### Community 122 - "net.minecraft.world.item.Item"
Cohesion: 0.05
Nodes (28): AquaTechFishingRodItem, Override, AbyssalMagnetItem, Mod.EventBusSubscriber, Override, InfernalPearlItem, Override, Override (+20 more)

### Community 129 - "net.minecraft.server.level.ServerLevel"
Cohesion: 0.13
Nodes (13): AbyssalPearlItem, BlockPos, Override, Vec3, InfernalPearlHandler, BlockPos, Mod.EventBusSubscriber, RightClickBlock (+5 more)
...
Cohesion: 0.06
Nodes (15): animate(), b(), f(), I, N(), n7, n8, se (+7 more)

### Community 136 - "ej"
Cohesion: 0.04
Nodes (11): ej, sb, sF, sk(), eH(), eN(), eO(), eV() (+3 more)
...
### Community 163 - ".copy"
Cohesion: 0.03
Nodes (13): h(), background(), e5, e9(), a(), n0, n1, om (+5 more)

### Community 164 - "IslandGuardHandler"
Cohesion: 0.15
...
Cohesion: 0.10
Nodes (10): SkillEffects, Snapshot, Override, Override, Override, Override, Override, SonarGogglesItem (+2 more)
...
### Community 198 - "Json"
Cohesion: 0.03
Nodes (5): Json, Neutralize aquatech SC fish preview (loot still from AquaTech rod pools)., b64(), main(), Boost density of vanilla underwater vegetation/decoration features (kelp,…
...
### Community 202 - "S2CSyncSkillsPacket"
Cohesion: 0.25
Nodes (3): CompoundTag, Context, S2CSyncSkillsPacket
...
### Community 206 - "ModClientConfig"
Cohesion: 0.33
Nodes (6): BooleanValue, ConfigValue, DoubleValue, IntValue, ModClientConfig, net.minecraftforge.common.ForgeConfigSpec
...
### Community 213 - "KitConfig"
Cohesion: 0.09
Nodes (10): com.mojang.brigadier.builder.LiteralArgumentBuilder, LumenCommands, Data, KitConfig, KitDef, KitItem, Data, ServerPlayer (+2 more)
...
Cohesion: 0.18
Nodes (7): ItemStack, FishingLootHandler, ItemStack, Mod.EventBusSubscriber, net.minecraft.util.RandomSource, net.minecraft.world.item.ItemStack, net.minecraftforge.event.entity.player.ItemFishedEvent

### Community 217 - ".isSupportedRod"
Cohesion: 0.15
Nodes (3): FishingRodCompat, RodDurability, net.minecraft.world.entity.LivingEntity
...
### Community 220 - "AquaTechLauncher.Core"
Cohesion: 0.11
...
### Community 228 - "ChestFallbackUI.java"
Cohesion: 0.16
...
### Community 256 - "tU"
Cohesion: 0.11
Nodes (11): ag, aM(), as(), r(), av(), ax(), ay(), dispose() (+3 more)

### Community 259 - "SeabedDredgerBlockEntity"
Cohesion: 0.13
...
### Community 268 - "SyncAllProfilesPacket"
Cohesion: 0.16
Nodes (4): PlayerProfile, Context, SyncAllProfilesPacket, UtfSafe

### Community 269 - "MariaStats"
Cohesion: 0.23
Nodes (5): java.sql.Driver, ClassLoader, JsonObject, MariaStats, PlayerRewards
...
### Community 286 - "AutoFisherBlockEntity.java"
Cohesion: 0.10
...
### Community 303 - "FishingSpeedHandler"
Cohesion: 0.31
...
### Community 311 - "CapabilityEvents"
Cohesion: 0.33
...
### Community 331 - "AquaSkillCapability.java"
Cohesion: 0.20
Nodes (7): DailyContract, DEPTH, FISH, KELP, MACHINE, MARKET, HorizonRoute
...
### Community 354 - ".QueryStatusAsync"
Cohesion: 0.33
Nodes (5): ServerPing, ServerStatusResult, Stream, Task, Ms

### Community 355 - "OceanFilterBlockEntity"
Cohesion: 0.23
Nodes (3): ItemStack, Override, OceanFilterBlockEntity

### Community 357 - "SkillPassiveHandler"
Cohesion: 0.22
...
### Community 366 - "SyncServerStatsPacket"
Cohesion: 0.32
...
## Knowledge Gaps
- **1513 isolated node(s):** `$schema`, `registry`, `blocks`, `components`, `assets` (+1508 more)
...
- **Why does `x` connect `x` to `.copy`, `skinview3d.bundle.js`, `.constructor`, `W`, `eu`, `.expandByPoint`, `tg`?**
...
- **Why does `HttpDownload` connect `HttpDownload` to `.ApplyAsync`, `AquaTechLauncher.Core`, `.LoginAsync`, `Fact`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
