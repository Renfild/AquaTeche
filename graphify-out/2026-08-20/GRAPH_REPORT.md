# Graph Report - AquaTech  (2026-08-20)

## Corpus Check
- 591 files · ~271,589 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3269 nodes · 6876 edges · 255 communities (216 shown, 39 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 91 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3b651ceb`
...
7. `AquaSkillCapability` - 44 edges
8. `Пар — steam` - 39 edges
9. `MainViewModel` - 38 edges
10. `handleApi()` - 36 edges
...
Cohesion: 0.08
Nodes (84): onRequestPatch(), mapRow(), onRequestGet(), onRequestPost(), parsePerks(), SHORT, onRequestGet(), onRequestDelete() (+76 more)

### Community 1 - "AquaTechFishingRodItem.java"
Cohesion: 0.08
Nodes (12): Override, Override, Override, Override, Override, UpgradeItem, UpgradeType, EFFICIENCY (+4 more)

### Community 2 - "net.minecraft.server.level.ServerPlayer"
Cohesion: 0.15
Nodes (5): ServerTickEvent, HubActionHandler, ItemStack, HubEconomy, net.minecraft.server.level.ServerPlayer
...
Cohesion: 0.13
Nodes (34): api(), applySiteCopy(), catalogCard(), cleanPrivilege(), copyIP(), ensureAudio(), esc(), formatNewsDate() (+26 more)

### Community 5 - "ForgeInstaller"
Cohesion: 0.29
...
### Community 17 - "SyncAllProfilesPacket"
Cohesion: 0.17
...
### Community 20 - "RhythmHookSession.java"
Cohesion: 0.19
...
Cohesion: 0.11
Nodes (15): com.google.gson.Gson, com.google.gson.JsonArray, com.google.gson.JsonObject, AquaLumenUI, Mod.EventBusSubscriber, ServerEvents, LumenConfig, LumenNetwork (+7 more)
...
Cohesion: 0.26
Nodes (8): Func, JsonObject, LaunchCommandBuilder, ProcessSpawner, Action, CancellationToken, List, Task
...
### Community 25 - "IslandGuardHandler"
Cohesion: 0.15
...
Cohesion: 0.08
Nodes (25): Override, OceanFilterBlockEntity, Override, SeabedDredgerBlockEntity, AquaSkillProvider, Override, ModBlockEntities, InventoryNbt (+17 more)
...
### Community 41 - "SyncServerStatsPacket"
Cohesion: 0.28
Nodes (3): ServerStats, Context, SyncServerStatsPacket

### Community 42 - "net.minecraft.world.item.Item"
Cohesion: 0.11
Nodes (13): AbyssalMagnetItem, Mod.EventBusSubscriber, PlayerLoggedOutEvent, PlayerTickEvent, RateModItem, RateTier, X16, X2 (+5 more)
...
Cohesion: 0.08
Nodes (34): AbyssalPortalBlock, BlockState, Override, AutoFisherBlock, BlockHitResult, Builder, Override, WorkingMachineTracker (+26 more)
...
### Community 50 - "CapabilityEvents"
Cohesion: 0.33
Nodes (4): CapabilityEvents, Clone, Mod.EventBusSubscriber, PlayerLoggedInEvent

### Community 51 - "HttpDownload"
Cohesion: 0.12
Nodes (18): Body, CookieContainer, CookieSession, Error, HttpClient, HttpDownload, PortalApi, PortalStats (+10 more)
...
Cohesion: 0.17
Nodes (7): CachedRank, HubDataService, ClassLoader, LevelData, Rank, SeasonData, WebTopRecord
...
### Community 56 - "HubSnapshot"
Cohesion: 0.18
Nodes (13): CaseEntry, FishEntry, HubSnapshot, KitEntry, LootInfo, Offer, Profile, Season (+5 more)
...
### Community 70 - "AquaTechLauncher.Core"
Cohesion: 0.08
...
### Community 79 - "net.minecraftforge.registries.RegistryObject"
Cohesion: 0.24
Nodes (6): ModCreativeTabs, ModSounds, net.minecraft.sounds.SoundEvent, net.minecraft.world.item.CreativeModeTab, net.minecraftforge.eventbus.api.IEventBus, net.minecraftforge.registries.RegistryObject
...
### Community 111 - "AutoFisherBlockEntity"
Cohesion: 0.16
...
### Community 118 - "AquaTechCommand.java"
Cohesion: 0.14
Nodes (4): NetworkHandler, Context, S2CSyncSkillsPacket, net.minecraftforge.event.RegisterCommandsEvent

### Community 122 - "net.minecraftforge.eventbus.api.SubscribeEvent"
Cohesion: 0.16
Nodes (13): java.lang.reflect.Field, AquaTechUI, net.minecraft.server.level.ServerLevel, net.minecraft.world.entity.Entity, net.minecraft.world.level.LevelAccessor, net.minecraft.world.level.saveddata.SavedData, net.minecraftforge.event.AttachCapabilitiesEvent, net.minecraftforge.event.CommandEvent (+5 more)

### Community 131 - "SkillTreeData"
Cohesion: 0.16
Nodes (3): SkillTreeData, C2SUnlockSkillPacket, Context

### Community 136 - ".openCase"
Cohesion: 0.22
Nodes (8): CaseResult, CaseConfig, CaseDef, Daily, Data, RandomSource, LootDef, PendingCaseReward

### Community 144 - "ponytail-audit/SKILL.md"
Cohesion: 0.40
Nodes (4): Boundaries, Hunt, Output, Tags

### Community 163 - "net.minecraft.world.entity.player.Inventory"
Cohesion: 0.09
Nodes (14): AutoFisherMenu, OceanAltarMenu, OceanFilterMenu, SeabedDredgerMenu, TackleBoxMenu, ModBlocks, ModItems, ModMenuTypes (+6 more)

### Community 164 - "CustomEnergyStorage"
Cohesion: 0.16
Nodes (6): ContainerData, ContainerData, ContainerData, CustomEnergyStorage, Override, net.minecraftforge.energy.EnergyStorage

### Community 167 - "WarpConfig"
Cohesion: 0.14
Nodes (6): com.mojang.brigadier.CommandDispatcher, LumenCommands, Data, ServerPlayer, WarpConfig, WarpDef

### Community 172 - "ZipFile"
Cohesion: 0.14
...
### Community 182 - "SkillDefinitions"
Cohesion: 0.22
...
### Community 198 - "Json"
Cohesion: 0.08
Nodes (10): Json, Harden aquatech StarCatcher fish: real minigame difficulty, no skip., Neutralize aquatech SC fish preview (loot still from AquaTech rod pools)., check_and_repair_mca(), main(), is_server_only(), main(), main() (+2 more)
...
### Community 202 - ".QueryStatusAsync"
Cohesion: 0.06
Nodes (22): AppBuilder, Application, Control, AquaTechLauncher.Views, AquaTechLauncher, AquaTechLauncher.ViewModels, DllImport, IDataTemplate (+14 more)
...
Cohesion: 0.11
Nodes (7): ClientHello, HubAction, C2SOpenSkillTreePacket, Context, Context, S2CSessionSyncPacket, net.minecraft.network.FriendlyByteBuf
...
### Community 213 - "OceanAltarBlockEntity"
Cohesion: 0.23
...
### Community 228 - "SkillPassiveHandler"
Cohesion: 0.22
...
Cohesion: 0.30
Nodes (4): JsonArray, CustomFishingLootManager, CustomLootEntry, ItemStack

### Community 236 - "net.minecraft.world.item.ItemStack"
Cohesion: 0.16
Nodes (6): ItemStack, ItemStack, Mod.EventBusSubscriber, PlayerTickEvent, RateModPersistHandler, net.minecraft.world.item.ItemStack

### Community 243 - "StarCatcherAttachments.java"
Cohesion: 0.25
Nodes (4): java.lang.reflect.Method, Mod.EventBusSubscriber, PlayerLoggedInEvent, SkyblockAutoIsland
...
## Knowledge Gaps
- **746 isolated node(s):** `aquatech/bootstrap`, `version`, `mc_version`, `forge_version`, `server_ip` (+741 more)
...
- **Why does `HttpDownload` connect `HttpDownload` to `MainViewModel`, `ForgeInstaller`, `AquaTechLauncher.Core`, `Fact`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `LaunchCommandBuilder` connect `.BuildAsync` to `.PlayAsync`, `Fact`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `HubDataService` connect `HubDataService` to `net.minecraft.server.level.ServerPlayer`, `StormEvent`, `WarpConfig`, `.openCase`, `StarCatcherAttachments.java`, `HubDataService.java`, `HubSnapshot`, `.onLoggedOut`?**
...
- **Should `index.js` be split into smaller, more focused modules?**
  _Cohesion score 0.07766116941529236 - nodes in this community are weakly interconnected._
- **Should `AquaTechFishingRodItem.java` be split into smaller, more focused modules?**
