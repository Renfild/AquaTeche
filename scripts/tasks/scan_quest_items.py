...
def main() -> None:
    ...
    pairs = [
        ...
        ("BotanicalMachinery-1.20.1-3.0.10.jar", "botanicalmachinery"),
        ("botanicalextramachinery-1.20.1-1.1.2.jar", "botanicalextramachinery"),
        ("MythicBotany-1.20.1-4.0.4.jar", "mythicbotany"),
        ("Re-Avaritia-forge-1.20.1-1.4.1-release.jar", "avaritia"),
        ("avaritia_armor-0.1.3.jar", "avaritia_armor"),
