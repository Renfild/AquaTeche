...
$aqualumen = Resolve-Jar @(
  "$root\server\mods\aqualumen-forge-1.20.1-0.3.2-alpha.jar",
  "$root\mods\aqualumen-ui\build\libs\aqualumen-forge-1.20.1-0.3.2-alpha.jar",
  "$root\mods\aqualumen-forge-1.20.1-0.3.2-alpha.jar"
)
