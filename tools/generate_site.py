...
PAGES["index.html"] = (
  ...
  <section class="hero">
    ...
    <div class="container hero-inner">
      <div class="eyebrow reveal">Minecraft 1.20.1 · Forge + Mohist</div>
      <h1 class="reveal reveal-delay-1">AquaTech <span>глубины</span></h1>
      <p class="hero-lead reveal reveal-delay-2">Океанский скайблок: плот, удочки StarCatcher, кейсы и индустриальные моды. Лаунчер сам подтянет сборку.</p>
    ...
    <div class="container">
      ...
      <div class="grid-3 reveal">
        <a class="card card-link" href="rods.html">
          ...
          <p>12 тиров с ресурсными пулами AquaTech.</p>
        </a>
        ...
        <a class="card card-link" href="top.html">
          ...
          <p>Рейтинги, поиск игроков, страница профиля.</p>
        </a>
      </div>
    </div>
  </section>
  ...
  <section class="section" style="padding-top:0">
    <div class="container grid-2">
      ...
      <div class="card reveal">
        ...
        <p style="margin:.55rem 0 1rem;color:var(--muted)">Один мир: океан, плот 4×4, кастомный UI.</p>
        ...
        <div style="margin-top:1rem;display:flex;gap:.55rem;flex-wrap:wrap">
          <a class="btn btn-aqua" href="start.html">Начать</a>
