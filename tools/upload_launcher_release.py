...
def main() -> None:
    ...
    body = (
        "## AquaTech Client 2.9.39\n\n"
        "- Bootstrap cache-bust + launcher update banner (restart via AquaTech.exe)\n"
        "- Bootstrap auto-update tests (go + python)\n"
    )
