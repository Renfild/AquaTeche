...
def main() -> None:
    ...
    body = (
        "## AquaTech Client 2.9.15\n\n"
        "- Soft purple-pink glass UI; single Play button (pack auto-updates on launch)\n"
        "- Unified server online status (TCP); nick sync to portal on Play\n"
    )
